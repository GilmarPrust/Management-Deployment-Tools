...
+----------------------------------------------------------------------------------------+
	...
	Filename:   Management.psm1
	.DESCRIPTION
	Publicar neste módulo todas as funções de Management.
+----------------------------------------------------------------------------------------+
#>
...
function Get-DeviceModelCatalog {
	...
	.\Get-DeviceModelCatalog.ps1 -Manufacturer $Manufacturer -Model $Model -Type $Type
}

Export-ModuleMember -Function Get-DeviceModelCatalog
