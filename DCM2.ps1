...
+----------------------------------------------------------------------------------------+
    ...
    .SYNOPSIS
    Deploy new DCM2, or start services.
...
param(
    ...
    [Parameter(ParameterSetName="Deploy")] [switch]$New,
    [Parameter(ParameterSetName="Stop")] [switch]$Stop
)
Set-Location -Path $PSScriptRoot
Import-Module -Name ..\Control -Scope Global -Force

### Set global variable.
New-Variable -Name DCM2Root -Value (Get-ControlSettings).DCM2Root -Scope Global -Force -Option ReadOnly
### Set location.
Set-Location -Path $DCM2Root -Verbose

### Import Deploy Module.
Import-Module .\DCM2 -Force -Verbose
