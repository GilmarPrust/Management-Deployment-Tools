...
function Deploy-DCM2 {
    Write-Host "Deploy new DCM server."
    ### verifica compartilhamentos,
    ### check PSResource.
    ### imvoke-Deployment check.
    .\Deployment\Invoke-Deployment.ps1 -BareMetal
}

function Start-DCM2 {
    Write-Host "Start DCM services."
    #load modulo Deployment
    
}

function Stop-DCM2 {
    Write-Host "Stop DCM services."
