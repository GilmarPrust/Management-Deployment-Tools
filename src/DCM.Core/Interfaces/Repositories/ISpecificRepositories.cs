...
namespace DCM.Core.Interfaces.Repositories
{
    ...
    public interface IDeviceRepository : IRepository<Device>
    {
        ...
        /// <summary>
        /// Adiciona um novo dispositivo ao repositório.
        /// </summary>
        ...
        /// <summary>
        /// Atualiza um dispositivo existente no repositório.
        /// </summary>
    ...
    public interface IDeviceModelRepository : IRepository<DeviceModel>
    {
        ...
        /// <summary>
        /// Obtém modelos com todas as relações incluídas.
        /// </summary>
        /// <param name="cancellationToken">Token de cancelamento</param>
        ...
        /// <summary>
        /// Obtém modelos ativos ordenados por fabricante e modelo.
        /// </summary>
        /// <param name="cancellationToken">Token de cancelamento</param>
    ...
    {
        /// <summary>
        /// Obtém todas as aplicações ativas ordenadas por DisplayName.
        /// </summary>
        /// <param name="cancellationToken">Token de cancelamento</param>
        ...
        /// <summary>
        /// Atualiza uma aplicação existente no repositório.
        /// </summary>
        /// <param name="existing">Aplicação a ser atualizada</param>
        /// <param name="cancellationToken">Token de cancelamento</param>
        /// <returns>Task que representa a operação assíncrona</returns>
        Task UpdateAsync(Application existing, CancellationToken cancellationToken);

        /// <summary>
        /// Verifica se existe uma aplicação com o ID especificado.
        /// </summary>
    ...
    public interface IAppxPackageRepository : IRepository<AppxPackage>
    {
        ...
        /// <summary>
        /// Adiciona um novo pacote AppX ao repositório.
        /// </summary>
        ...
        /// <summary>
        /// Atualiza um pacote AppX existente no repositório.
        /// </summary>
    ...
    public interface IOperatingSystemRepository : IRepository<OSEntity>
    {
        ...
        /// <summary>
        /// Adiciona um novo sistema operacional ao repositório.
        /// </summary>
        ...
        /// <summary>
        /// Atualiza um sistema operacional existente no repositório.
        /// </summary>
