...
{
    public class AppxPackageService(AppDbContext context, IMapper mapper, ILogger<AppxPackageService> logger) : IAppxPackageService
    {
        private readonly AppDbContext _context = context;
        private readonly IMapper _mapper = mapper;
        private readonly ILogger<AppxPackageService> _logger = logger;
