...
namespace DCM.Application.Services.Implementations
{
    ...
    public sealed class AppxPackageService : IAppxPackageService
    {
        ...
        public Task<IEnumerable<AppxPackageReadDTO>> GetAllAsync()
        {
            throw new NotImplementedException();
        }

        public Task<AppxPackageReadDTO?> GetByIdAsync(Guid id)
        {
            throw new NotImplementedException();
        }

        public Task<AppxPackageReadDTO> CreateAsync(AppxPackageCreateDTO dto)
        {
            throw new NotImplementedException();
        }

        public Task<AppxPackageReadDTO?> UpdateAsync(Guid id, AppxPackageUpdateDTO dto)
        {
            throw new NotImplementedException();
        }
