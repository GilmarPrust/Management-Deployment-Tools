...
namespace DCM.Infrastructure.Repositories
{
    ...
    public class DeviceModelRepository : Repository<DeviceModel>, IDeviceModelRepository
    {
        ...
        /// <inheritdoc/>
        public async Task<IEnumerable<DeviceModel>> GetAllActiveAsync(CancellationToken cancellationToken = default)
        {
            return await _dbSet
                .Where(e => !e.IsDeleted && e.Enabled)
                .OrderBy(dm => dm.Manufacturer)
                .ThenBy(dm => dm.Model)
                .ToListAsync(cancellationToken);
        }
        ...
        /// <inheritdoc/>
        public async Task<bool> ExistsAsync(Guid deviceModelId, CancellationToken cancellationToken)
        {
            return await base.AnyAsync(e => e.Id == deviceModelId, cancellationToken);
        }
    }
    ...
    public class ApplicationRepository : Repository<Application>, IApplicationRepository
    {
        ...
        /// <inheritdoc/>
        public async Task<bool> ExistsByNameIdAsync(string nameID, CancellationToken cancellationToken = default)
        {
            if (string.IsNullOrWhiteSpace(nameID))
                return false;
            ...
            return await _dbSet
                .Where(e => !e.IsDeleted)
                .AnyAsync(a => a.NameID == nameID, cancellationToken);
        }
