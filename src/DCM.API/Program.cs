...
// Registro automático de todos os validators de todos os assemblies carregados
...
using (var scope = app.Services.CreateScope())
{
    ...
    dbContext.Database.Migrate(); // Garante que as migrações estão aplicadas
    dbContext.SeedDefaultData();  // Chama o método de seed
}

// Chama o registro automático de endpoints
app.MapEndpoints();
