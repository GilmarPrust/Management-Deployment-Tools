...
namespace API.Control.Migrations
{
    ...
    [Migration("20250713215618_RecreateDevice")]
    partial class RecreateDevice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Control.Models.DriverPackage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DeviceDriverPackage", b =>
                {
                    b.Property<Guid>("DevicesId")
                        .HasColumnType("TEXT");

                    b.Property<Guid>("DriverPackagesId")
                        .HasColumnType("TEXT");

                    b.HasKey("DevicesId", "DriverPackagesId");

                    b.HasIndex("DriverPackagesId");

                    b.ToTable("DeviceDriverPackage");
                });
            ...
            modelBuilder.Entity("DeviceDriverPackage", b =>
                {
                    ...
                    b.HasOne("API.Control.Models.DriverPackage", null)
                        .WithMany()
                        .HasForeignKey("DriverPackagesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
