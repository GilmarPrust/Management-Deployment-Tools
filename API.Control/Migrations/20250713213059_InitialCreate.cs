        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageFamilyName = table.Column<string>(type: "TEXT", nullable: false),
                    PackageFullName = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageIndex = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileDeploys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfileDeploys_Image_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationProfileDeploy",
                columns: table => new
                {
                    ApplicationsId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProfileDeploysId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationProfileDeploy", x => new { x.ApplicationsId, x.ProfileDeploysId });
                    table.ForeignKey(
                        name: "FK_ApplicationProfileDeploy_Applications_ApplicationsId",
                        column: x => x.ApplicationsId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationProfileDeploy_ProfileDeploys_ProfileDeploysId",
                        column: x => x.ProfileDeploysId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ComputerName_Value = table.Column<string>(type: "TEXT", nullable: false),
                    SerialNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    MacAddress = table.Column<string>(type: "TEXT", nullable: false),
                    Enabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    DeviceModelId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProfileDeployId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationProfileDeploy_ProfileDeploysId",
                table: "ApplicationProfileDeploy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileDeploys_ImageId",
                table: "ProfileDeploys",
                column: "ImageId");
        }
