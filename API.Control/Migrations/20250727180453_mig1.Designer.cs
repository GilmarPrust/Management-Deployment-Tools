...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Control.Models.Manufacturer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Control.Models.PathToCopy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Control.Models.ProfileTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Control.Models.PathToCopy", b =>
                {
                    b.HasOne("API.Control.Models.ProfileTask", "ProfileTasks")
                        .WithMany()
            ...
            modelBuilder.Entity("DeployProfileProfileTask", b =>
                {
                    ...
                    b.HasOne("API.Control.Models.ProfileTask", null)
                        .WithMany()
                        .HasForeignKey("ProfileTasksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
