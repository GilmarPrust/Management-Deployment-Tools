...
+----------------------------------------------------------------------------------------+
    .DESCRIPTION
    Register new resource PS repository.
...
Get-PSResourceRepository -Name DCM2_PSResources | Unregister-PSResourceRepository -Verbose

Register-PSResourceRepository -Name $settings.PSResources.Name  -Uri $settings.PSResources.Uri -Trusted -Priority 100 -Force

return Get-PSResourceRepository -Name $settings.PSResources.Name
